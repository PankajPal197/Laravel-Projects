...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <form class="container mt-3" action="" method="">
        @csrf
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" name="class" class="form-control" id="inputPassword4" placeholder="Class">
          </div>
        </div>
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" id="inputZip" name="section" placeholder="Section">
          </div>
        <div class="form-row">
          <div class="form-group col-md-6">
